...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": ativar para classificar a coluna ascentente",sSortDescending:": ativar para classificar a coluna decrescente"},oPaginate:{sFirst:"Primeiro",sLast:"Último",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Nenhum dado disponível na tabela",sInfo:"Mostrando _START_ para _END_ de _TOTAL_ resultados",sInfoEmpty:"Mostrando 0 para 0 de 0 entradas",

<?php
        ...
        $sql = "SELECT t.id as id, concat(t.ano, ' ', t.curso) as turma, t.id as turmaid, t.id as id_t, a.nome as aluno from tb_turma t join tb_aluno a on a.id_turma = t.id order by t.curso, t.ano;";
        $result = $conn->query($sql);
        $i = 1;
        $a = 1;
